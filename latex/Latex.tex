...
\author{
    \textbf{Bitache Matei} \\
    \small \texttt{matei.bitache@s.unibuc.ro}
    \and
    \textbf{Ungureanu Robert-Gabriel} \\
    \small \texttt{robert-gabriel.ungureanu1@s.unibuc.ro}
    \and
    \textbf{Ungureanu Eduard-Mihai} \\
    \small \texttt{eduard-mihai.ungureanu@s.unibuc.ro}
}
\date{\textbf{NLP Final Project}}
...
the hybrid method predicts \texttt{joy} with confidence 0.8847. The same CSV output includes one column for each emotion score, making the predictions easy to inspect and reuse in reports.
